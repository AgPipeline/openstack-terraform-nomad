...
variable "nomad_cluster_do_bootstrap" {
  default = "1"
}
...
variable "nomad_server_security_group_ids" {
}

variable "nomad_network_id" {
}

variable "nomad_consul_version" {
}

variable "nomad_app_name" {
}
